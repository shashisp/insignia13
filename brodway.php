  ...
  <table width="100%"  border="0">
	...
	<ul id="panel">
       <li class="animation"><a href="index.php">Home</a></li>
        <li class="animation"><a href="javascript:ajaxpage('ajaxfiles/brod_marchant.php', 'rightcolumn');">Merchants of Venice</a></li>
        <li class="animation"><a href="javascript:ajaxpage('ajaxfiles/brod_tamasha.php', 'rightcolumn');">Tamasha</a></li>
        <li class="animation"><a href="javascript:ajaxpage('ajaxfiles/brod_mad.php', 'rightcolumn');">Take a Break</a></li> 
    </ul>
</div>
	  <p>&nbsp; </p>
       <p>&nbsp; </p>
    ...
    <table width="129%" height="86%" border="0" bgcolor="#000000" >
        <tr>
          <td width="250" align="left" valign="middle"><img src="images/Broadway.jpg" width="250" height="170" /></td>
          <td width="741" align="center" valign="middle" style="font-size:24px; color:#0CF;">Broadway</td>
         ...
         <tr>
          ...
          <b><i>“All the world’s a stage”- William Shakespeare…</i></b></p>
          <p style="font-size:16px;">&nbsp;</p>
          <p style="font-size:16px;"><b><i> Drama as they say is the purest form of expression. Indian theatre in itself has always been setting examples to the world about its audacious, passionate and lucid ways of expression. Anupam Kher, Girish Karnad, Pankaj Kapoor, Nasseruddin Shah are amazing examples of why “the theatre” is so successful and relevant in today’s society. </i></b></p>
           <table width="692" border="0" id="culturalevents" bgcolor="#000000">
                    <tr>
                      <td height="42" colspan="3"><p style="color:#F00; font-size:22px;"></p></td>
                    </tr>
                    <tr>
                      <td height="83" align="center"><a href="javascript:ajaxpage('ajaxfiles/brod_marchant.php', 'rightcolumn');"><input type="image" id="surevent" src="images/merchants of venice.jpg" width="150" height="100" /></a></td>
                       
                      <td align="center" valign="middle"><a href="javascript:ajaxpage('ajaxfiles/brod_tamasha.php', 'rightcolumn');"><input type="image" id="resevent" src="images/tamasha.jpg" width="150" height="100" /></a></td>
                      <td align="center" valign="middle"><a href="javascript:ajaxpage('ajaxfiles/brod_mad.php', 'rightcolumn');"><input type="image" id="cvs" src="images/mad.jpg" width="150" height="100" /></a></td>
                       
                    </tr>
                    <tr>
                      <td height="28" align="center" valign="middle"><font color="#F00" style="font-size:16px;">Merchants of Venice</font></td>
                      <td align="center" valign="middle"><font color="#F00" style="font-size:16px;">Tamasha</font></td>
                      <td align="center" valign="middle"><font color="#F00" style="font-size:16px;">Take A Break</font></td>
